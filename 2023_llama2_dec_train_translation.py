...
if os.path.isfile('./checkpoints/llama2_Sentencepiece.pt'):
    model.load_state_dict(torch.load('./checkpoints/llama2_Sentencepiece.pt'))
...
for epoch in range(N_EPOCHS):
    ...
    if train_loss < best_epoch_loss:
        ...
        torch.save(model.state_dict(), './checkpoints/llama2_Sentencepiece.pt')
...
trained_model = Llama2Model(LLAMA2_CONFIG_7B).to(device)
trained_model.load_state_dict(torch.load('./checkpoints/llama2_Sentencepiece.pt'))
