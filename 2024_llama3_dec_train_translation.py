...
if os.path.isfile('./checkpoints/llama3_Sentencepiece.pt'):
    model.load_state_dict(torch.load('./checkpoints/llama3_Sentencepiece.pt'))
...
for epoch in range(N_EPOCHS):
    ...
    if train_loss < best_epoch_loss:
        ...
        torch.save(model.state_dict(), './checkpoints/llama3_Sentencepiece.pt')
...
trained_model.load_state_dict(torch.load('./checkpoints/llama3_Sentencepiece.pt'))
